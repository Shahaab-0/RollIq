...
export function useCreateTechnique() {
  ...
  return useMutation({
    ...
    onError: error =>
      showToast(getApiErrorMessage(error, 'Could not save this technique'), 'error'),
...
export function useIncrementDrillCount() {
  ...
  return useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ['techniques'] }),
    onError: error => showToast(getApiErrorMessage(error, 'Could not log that drill'), 'error'),
...
export function useDeleteTechnique() {
  ...
  return useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ['techniques'] }),
    onError: error =>
      showToast(getApiErrorMessage(error, 'Could not delete this technique'), 'error'),
