...
// Fixed set (unlike category) -- checked at the database level too, see
// backend's V4__instructional_difficulty.sql.
...
export interface Instructional {
  ...
  // Computed server-side from this user's progress -- see backend's
  // InstructionalRepository.findAllWithProgressSummary.
  video_count: number;
