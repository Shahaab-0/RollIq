...
import { CATEGORY_PRESETS, DIFFICULTY_OPTIONS, type Difficulty } from '../types';
...
export default function InstructionalForm() {
  ...
  return (
    <div className="flex w-full max-w-2xl flex-col gap-4">
      <h1 className="text-2xl font-extrabold tracking-tight text-text-primary">New Instructional</h1>
